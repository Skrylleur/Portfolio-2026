...
import { ExternalLink, Github, Calendar, User, Code2, CheckCircle2, Clock, ArrowLeft } from "lucide-react"
...
export default function AllProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      {/* Header Section */}
      <section className="pt-0 pb-4 px-6 relative">
